...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.availability'
        db.add_column(u'projects_member', 'availability',
                      self.gf('django.db.models.fields.CharField')(default='reader', max_length=20),
                      keep_default=False)

        # Adding M2M table for field projects_active on 'Member'
        m2m_table_name = db.shorten_name(u'projects_member_projects_active')
    ...
    def backwards(self, orm):
        # Deleting field 'Member.availability'
        db.delete_column(u'projects_member', 'availability')

        # Removing M2M table for field projects_active on 'Member'
        db.delete_table(db.shorten_name(u'projects_member_projects_active'))
