...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.logo_thumb'
        db.add_column(u'projects_project', 'logo_thumb',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.complimenting_color'
        db.add_column(u'projects_project', 'complimenting_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.logo_thumb'
        db.delete_column(u'projects_project', 'logo_thumb')

        # Deleting field 'Project.complimenting_color'
        db.delete_column(u'projects_project', 'complimenting_color')
