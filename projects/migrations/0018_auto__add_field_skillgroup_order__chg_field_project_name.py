...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkillGroup.order'
        db.add_column(u'projects_skillgroup', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Project.name'
        db.alter_column(u'projects_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):
        # Deleting field 'SkillGroup.order'
        db.delete_column(u'projects_skillgroup', 'order')


        # Changing field 'Project.name'
        db.alter_column(u'projects_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        u'projects.skillgroup': {
            'Meta': {'ordering': "['order']", 'object_name': 'SkillGroup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
