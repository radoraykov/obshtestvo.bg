...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'projects_event', (
        ...
        db.send_create_signal(u'projects', ['Event'])

        # Adding M2M table for field organizers on 'Event'
        m2m_table_name = db.shorten_name(u'projects_event_organizers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'projects.event'], null=False)),
            ('organisation', models.ForeignKey(orm[u'projects.organisation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['event_id', 'organisation_id'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table(u'projects_event')

        # Removing M2M table for field organizers on 'Event'
        db.delete_table(db.shorten_name(u'projects_event_organizers'))
