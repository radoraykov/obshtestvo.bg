...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field skills on 'User'
        m2m_table_name = db.shorten_name(u'projects_user_skills')
    ...
    def backwards(self, orm):
        # Removing M2M table for field skills on 'User'
        db.delete_table(db.shorten_name(u'projects_user_skills'))
