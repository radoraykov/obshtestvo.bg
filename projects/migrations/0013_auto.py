...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field projects_interests on 'User'
        m2m_table_name = db.shorten_name(u'projects_user_projects_interests')
        ...
        db.create_unique(m2m_table_name, ['user_id', 'project_id'])


    def backwards(self, orm):
        # Removing M2M table for field projects_interests on 'User'
        db.delete_table(db.shorten_name(u'projects_user_projects_interests'))
