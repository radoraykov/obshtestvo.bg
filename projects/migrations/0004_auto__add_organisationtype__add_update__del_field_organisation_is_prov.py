...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_organisationtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'projects', ['OrganisationType'])
        ...
        db.create_table(m2m_table_name, (
            ...
            ('organisationtype', models.ForeignKey(orm[u'projects.organisationtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['organisation_id', 'organisationtype_id'])


    def backwards(self, orm):
        # Deleting model 'OrganisationType'
        db.delete_table(u'projects_organisationtype')
