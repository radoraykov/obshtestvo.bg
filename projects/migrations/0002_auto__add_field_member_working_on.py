...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.working_on'
        db.add_column(u'projects_member', 'working_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='working_members', null=True, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.working_on'
        db.delete_column(u'projects_member', 'working_on_id')
