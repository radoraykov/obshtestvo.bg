...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
        # Adding index on 'Project', fields ['slug']
        db.create_index(u'projects_project', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['slug']
        db.delete_index(u'projects_project', ['slug'])


        # Changing field 'Project.slug'
        db.alter_column(u'projects_project', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
