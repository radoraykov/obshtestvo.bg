...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_skillgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'projects', ['SkillGroup'])

        # Adding M2M table for field groups on 'Skill'
        m2m_table_name = db.shorten_name(u'projects_skill_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('skill', models.ForeignKey(orm[u'projects.skill'], null=False)),
            ('skillgroup', models.ForeignKey(orm[u'projects.skillgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['skill_id', 'skillgroup_id'])


    def backwards(self, orm):
        # Deleting model 'SkillGroup'
        db.delete_table(u'projects_skillgroup')

        # Removing M2M table for field groups on 'Skill'
        db.delete_table(db.shorten_name(u'projects_skill_groups'))
    ...
    models = {
        ...
        u'projects.skill': {
            'Meta': {'ordering': "['group__name', 'name']", 'object_name': 'Skill'},
