...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Member.will_help'
        db.delete_column(u'projects_member', 'will_help')

        # Deleting field 'Member.is_active'
        db.delete_column(u'projects_member', 'is_active')


    def backwards(self, orm):
        # Adding field 'Member.will_help'
        db.add_column(u'projects_member', 'will_help',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Member.is_active'
        db.add_column(u'projects_member', 'is_active',
